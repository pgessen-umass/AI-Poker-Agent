...
class GameSimulator:
    ...
    def simulate_call(state, QModel, nonTensorState, round_state, hole_cards, op_histories=None):
        ...
        if op_histories is None:
            return simulated_rewards * (card_utils.estimate_hole_card_win_rate(GameSimulator.NUM_SIM,2, hole_cards, community_cards) if hole_cards is not None else 0.5)
                ...
                if our_action_2 == 0:
                    ...
                    if our_amount_2 == 0:
                        ...
                        if op_action_2 == 0:
                            ...
                            return simulated_rewards * (card_utils.estimate_hole_card_win_rate(GameSimulator.NUM_SIM,2, hole_cards, community_cards) if hole_cards is not None else 0.5) + op_amount_2
                        else:
                            return simulated_rewards * (card_utils.estimate_hole_card_win_rate(GameSimulator.NUM_SIM,2, hole_cards, community_cards) if hole_cards is not None else 0.5) + op_amount_2 + 10
                else:
